...
if __name__ == "__main__":
    fold="長恨歌"
    input_folder = r"c:\Users\ChengYu\Desktop\ai2026s\ai2026s\hw02\02-1_crop_paper_self\rotated_"+fold
    output_folder = r"crop\crop_"+fold
    ...
    json_path = r".\CP950\CP950-"+fold+".json"
    unicode_num = 840
